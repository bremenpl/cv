...
\begin{itemize}
	...
	\item C
		\begin{itemize}
			...
			\item Linux Kernel drivers development (character and network drivers) for self built Buildroot based kernel images,
	...
	\item C++
		\begin{itemize}
			...
			\item long time experience in using Qt with QML frameworks. Utilized Qt technology for building truly multiplatform (desktop and mobile) applications,
